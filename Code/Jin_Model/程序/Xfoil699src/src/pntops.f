...
C----- scales,offsets have changed... replot
      ...
      ENDIF
C
C---- abort button pushed or "A" typed?
      IF(LGUI(KABORT,XCRS,YCRS) .OR. INDEX('Aa',KCHAR).NE.0) RETURN
C
C
...
C----- scales,offsets have changed... replot
      ...
      ENDIF
C
      IF(LGUI(KABORT,XCRS,YCRS) .OR. INDEX('Aa',KCHAR).NE.0) THEN
