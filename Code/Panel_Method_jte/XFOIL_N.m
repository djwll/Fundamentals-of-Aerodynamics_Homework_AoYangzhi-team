function [xFoilResults,success] = XFOIL_N(NACA,PPAR,AoA,AF_load)

% FUNCTION - CALL XFOIL AND GET AIRFOIL DATA // N AIRFOILS
% Written by: JoshTheEngineer
% YouTube   : www.youtube.com/joshtheengineer
% Website   : www.joshtheengineer.com
% GitHub    : www.github/jte0419
% Started: 02/17/20
% Updated: 02/17/20 - Started code
%                   - Works as expected
%          06/20/20 - Updated for different method of loading
% 
% PURPOSE
% - Create or load airfoil based on AF_load
...
%
% INPUTS
% - NACA     : Four or five digit NACA airfoil designation
% - PPAR     : Paneling variables used in XFOIL PPAR menu
% - AoA      : Angle of attack [deg]
% - AF_load  : Flag for loading/creating airfoil
%                   0 = Create NACA airfoil in XFOIL
%                   1 = Load airfoil from database
% 
% OUTPUTS
...
if (AF_load == 0)                                                           % If the user wants XFOIL to create a NACA airfoil
...
elseif (AF_load == 1)                                                       % If the user wnats to load a DAT file airfoil
    flnm                = [NACA '.dat'];
...
if (AF_load == 1)                                                           % If user wants to load DAT airfoil file
    fprintf(fid,['LOAD ' './Airfoil_DAT_Selig/' flnm '\n']);                % Load selected airfoil
elseif (AF_load == 0)                                                       % If user wants to specify a 4-digit airfoil
