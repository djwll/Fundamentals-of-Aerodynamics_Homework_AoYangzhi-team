...
ccc  &   /'   READ   Read in Qspec from file'
ccc  &   /'   WRIT   Write out Qspec to file'
     &  //'   Modi   Modify Qspec'
...
C
      ...
      SUBROUTINE PUTVOV(KQSP)
C---- write S,Qspec for flow condition KQSP to file
      INCLUDE 'XFOIL.INC'
C
      LU = 2
      CALL ASKS('Enter Qspec vs s data filename^',FNAME)
